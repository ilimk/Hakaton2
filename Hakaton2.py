...
# l = [1,2,3,4,6, 6, 7]
# Please write more than 7 values
...
# print(f'Процент верхнего регистра {str(int(uppers / (uppers + lowers) * 100))}%')

# print(f'Процент нижнего регистра {str(int(lowers / (uppers + lowers) * 100))}%')
...
# Задача 4
# "Напишите функцию которая принимает в себя словарь где ключи это номера а значения
# страны. Попросите пользователя ввести страну или ключ и выдайте ему результат."


# d = {'1': 'kyrgyzstan', '2': 'kazahstan'}

# a = input('Введите название страны или ключ')
